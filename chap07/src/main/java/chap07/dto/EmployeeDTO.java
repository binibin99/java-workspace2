...
public class EmployeeDTO {
	...
	public EmployeeDTO(Integer employee_id, String first_name, String last_name, Double salary, Double commision_pct,
	...
	public String getDivRow() {
		return String.format("<div>%d</div>"
				...
				commision_pct, hire_date, job_id, manager_id, department_id);
	}
