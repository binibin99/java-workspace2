...
<body>
	...
	<ul>
		<li>JSP에서 어트리뷰트에 실려있는 값들을 간단하게 꺼내 쓸 수 있는 분법</li>
		<li>문법의 생김새가 Javascript의 format string과 똑같이 생겨서 JSP 내부에서는 충돌이
			발생한다</li>
		<li>어트리뷰트에 객체가 들어있는 경우 해당 객체의 getter를 통해 속성을 꺼내 사용할 수 있다</li>
		<li>여러 영역에 어트리뷰트가 같은 이름으로 등록되어 있는 경우ㄴ
	...
	<ul>
		...
		<li>해당 객체에 .을 찍고 속성을 호출하면
			실제로는 해당 객체의 Getter 매서드를 호출하여 사용한다</li>
		<li>${stu1}</li>
	...
	<!-- EL로 계산이 어느정도 가능하지만.. 포워딩으로 JSP로 오기 전에 모든 계산을 끝내는 편이 좋다 -->
	<div>${a + b}, ${a - b}, ${a * b}, ${a % b}, ${a mod b}</div>
	<div>${a == b}, ${a eq b}, ${a != b}, ${a ne b}, ${10 < 7}, ${10 lt 7}, ${10 > 7}, ${10 gt 7}
