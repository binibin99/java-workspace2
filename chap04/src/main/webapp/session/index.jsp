...
<body>
	...
	<ol>
		...
		<li>발급받은 세션ID는 클라이언트측의 웹 브라이저에 저장된다
		...
		<li>세션ID는 개인 사물함 열쇠 같은 역할을 하기도 한다
			세션 어트리뷰트에 접근할 때 해당 세션ID로 열쇠로 사용한다</li>
		<li>세션 객체에 너무 많은 양의 데이터를 추가하는 것은
			서버의 성능을 저하시킬 수 있으므로 주의해야 한다</li>
		<li>세션ID는 기본적으로 사용자의 웹 브라이저가 종료될 때 함께 사라지도록 설정되어 있다</li>
		<li>세션 어트리;뷰트는 일정시간동안 요청을 받지 않으면 사라지도록 설정되어 있다</li>
	</ol>
